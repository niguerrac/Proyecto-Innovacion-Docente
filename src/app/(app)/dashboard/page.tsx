    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{userProgressData.filter(p => p.progress < 100).length} Módulos</div>
      ...
      <div>
        <h2 className="text-2xl font-bold tracking-tight mb-4">Continúa Aprendiendo</h2>
